...
export const Quote = () => {
  ...
  return (
    <section id="devis" className="relative py-24 md:py-32 border-t border-white/5 bg-[#080808]" data-testid="quote-section">
        ...
        <Reveal delay={0.15}>
          {sent ? (
            <motion.div
              ...
              className="h-full min-h-[400px] flex flex-col items-center justify-center text-center border border-gold/30 bg-[#0a0a0a] p-10"
            ...
            <form onSubmit={onSubmit} className="space-y-8" data-testid="quote-form">
              ...
              <label className="flex items-center gap-4 border-b border-white/20 py-3 cursor-pointer hover:border-gold transition-colors duration-300" data-testid="quote-file-label">
                ...
                <span className="text-white/60 truncate">
                  {fileName || "Téléverser un fichier (logo, visuel...)"}
                </span>
                <input
                  type="file"
                  className="hidden"
              ...
              <button
                type="submit"
                className="group w-full inline-flex items-center justify-center gap-2 bg-gold text-black font-semibold px-8 py-4 hover:bg-gold-light transition-colors duration-300"
